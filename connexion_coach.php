...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user && password_verify($password, $user['mdp_hash'])&& $user['role'] == 'coach') {
        ...
        header("Location: compte-coach-connecte.php");
...
<body>
    ...
    <div class="form-container">  
        <div class="card">
            <h4 class="title">Connection to coach session</h4>
            <form method="POST">
                <div class="field">
