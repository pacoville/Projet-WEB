...
<body>
    ...
    <div class="form-container">  
        <div class="card">
            <h4 class="title">Connection to client session</h4>
            <form method="POST">
                <div class="field">
    ...
    <div id="navigation">
        ...
        <div class="nav-item">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="compte-client.html"> Compte client</a>
                <a class="dropdown-item" href="compte-coach.html"> Compte coach</a>
                <a class="dropdown-item" href="coach-admin.html"> Compte administrateur</a>
        ...
        <table>
            ...
            <tr>
                <td>
                    ...
                    <p>0139287600</p>
                    <p>15 Rue de Grenelle 75015 PARIS</p>
                </td>
            </tr>
        </table> 
    </div>
